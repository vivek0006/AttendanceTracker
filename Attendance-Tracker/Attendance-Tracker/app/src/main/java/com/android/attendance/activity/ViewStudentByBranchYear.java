...
public class ViewStudentByBranchYear extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		{
			String users = "First Name:"+studentBean.getStudent_firstname()+"\nLast Name:"+studentBean.getStudent_lastname()+"\nRoll Number:"+studentBean.getStudent_id();
		...
		listView.setOnItemLongClickListener(new OnItemLongClickListener() {
			...
			public boolean onItemLongClick(AdapterView<?> arg0, View arg1,
				...
				alertDialogBuilder.setMessage("Are you sure to delete the selected item from the record?");
